-- Respaldo de Base de Datos: gestion_flotilla
-- Fecha: 2023-10-27
...
--
-- Base de datos: `gestion_flotilla`
--
...
--
-- (Se omiten el resto de las tablas y vistas por brevedad, pero seguirían la misma estructura que el código proporcionado en las secciones anteriores)
--
